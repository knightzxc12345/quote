...
public class Common {
    ...
    public static final UUID SYSTEM = UUID.fromString("7864c635-7d4b-6284-927c-49698f16e8cf");

    public static final UUID MANAGER = UUID.fromString("2f855f8d-9f5e-4cd4-bfbf-e6ccad4287cb");

    public static final UUID BUSINESS = UUID.fromString("0e3afb66-e332-4113-bfcd-a76c563413f4");
