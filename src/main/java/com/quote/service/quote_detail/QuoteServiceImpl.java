...
import com.quote.repository.quote_detail.QuoteDetailRepository;
...
public class QuoteServiceImpl implements QuoteDetailService {
    ...
    public List<QuoteDetailEntity> findAll(String quoteUuid) {
        return quoteDetailRepository.findByIsDeletedFalseAndQuoteUuidOrderByIndexAsc(quoteUuid);
    }
